        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                >
                    ...
                    <ul className={`bg-white flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 absolute lg:static lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 transition-all duration-500 ease-in ${open ? 'top-10': 'top-[-490px]'}`}>
                        {
